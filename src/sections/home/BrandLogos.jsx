...
const LogoCell = React.memo(({ logo }) => (
  <div className="flex flex-col items-center justify-center p-12 border-b border-r border-gray-100 hover:bg-gray-50 transition-colors">
    <div className="w-20 h-20 mb-6 flex items-center justify-center bg-gray-50 rounded-full">
      ...
      <span className="text-3xl font-bold text-gray-300">{logo.name[0]}</span>
    </div>
    <span className="text-lg font-bold text-gray-800">{logo.name.toUpperCase()}</span>
    <span className="text-xs text-gray-400 mt-1">{logo.sub}</span>
  </div>
));
  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          <p className="text-gray-500 font-medium uppercase tracking-widest text-sm mb-3">
            International Brands
          </p>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 max-w-lg">
